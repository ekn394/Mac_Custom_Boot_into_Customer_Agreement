...
# create buttons
button = Button(canvas1, text=" I Agree", font=helv24, command = showAgreeMessage, bg='#0052cc', fg="#ffffff", height=100, borderless=1, width=200)
button2 = Button(canvas1, text="I Disagree", font=helv24, command = showDeclineMessage, height=100,borderless=1, width=200, bg='#0052cc', fg="#ffffff")
